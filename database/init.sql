...
('province', 'https://cdn.example.com/images/ha-noi.jpg', 'Hà Nội', 240, 'Thủ đô của Việt Nam với nhiều di tích lịch sử và văn hoá.', 'ha-noi'),
('province', 'https://cdn.example.com/images/ho-chi-minh.jpg', 'Hồ Chí Minh', 220, 'Trung tâm kinh tế lớn nhất cả nước, sôi động về đêm.', 'ho-chi-minh'),
('province', 'https://cdn.example.com/images/hai-phong.jpg', 'Hải Phòng', 110, 'Thành phố cảng miền Bắc, nổi tiếng với ẩm thực hải sản.', 'hai-phong'),
('province', 'https://cdn.example.com/images/da-nang.jpg', 'Đà Nẵng', 150, 'Thành phố biển miền Trung, gần nhiều điểm du lịch nổi tiếng.', 'da-nang'),
('province', 'https://cdn.example.com/images/can-tho.jpg', 'Cần Thơ', 95, 'Trung tâm đồng bằng sông Cửu Long, nổi tiếng với chợ nổi.', 'can-tho'),
('province', 'https://cdn.example.com/images/an-giang.jpg', 'An Giang', 78, 'Tỉnh ven sông, có nhiều di tích văn hoá và lễ hội.', 'an-giang'),
('province', 'https://cdn.example.com/images/ba-ria-vung-tau.jpg', 'Bà Rịa - Vũng Tàu', 130, 'Tỉnh biển với nhiều bãi tắm và khu du lịch nghỉ dưỡng.', 'ba-ria-vung-tau'),
('province', 'https://cdn.example.com/images/bac-giang.jpg', 'Bắc Giang', 67, 'Tỉnh phía Bắc với các khu công nghiệp và danh lam.', 'bac-giang'),
('province', 'https://cdn.example.com/images/bac-kan.jpg', 'Bắc Kạn', 52, 'Tỉnh miền núi phía Bắc, nhiều cảnh quan thiên nhiên.', 'bac-kan'),
('province', 'https://cdn.example.com/images/bac-lieu.jpg', 'Bạc Liêu', 60, 'Tỉnh đồng bằng sông Cửu Long, nổi tiếng văn hoá đờn ca tài tử.', 'bac-lieu'),
('province', 'https://cdn.example.com/images/bac-ninh.jpg', 'Bắc Ninh', 88, 'Vùng đất Kinh Bắc với nhiều di sản văn hoá truyền thống.', 'bac-ninh'),
('province', 'https://cdn.example.com/images/ben-tre.jpg', 'Bến Tre', 73, 'Tỉnh sông nước miền Tây, nổi tiếng dừa và du lịch miệt vườn.', 'ben-tre'),
('province', 'https://cdn.example.com/images/binh-dinh.jpg', 'Bình Định', 85, 'Tỉnh miền Trung có nhiều di tích võ cổ truyền và bãi biển.', 'binh-dinh'),
('province', 'https://cdn.example.com/images/binh-duong.jpg', 'Bình Dương', 140, 'Trung tâm công nghiệp và đô thị đang phát triển nhanh.', 'binh-duong'),
('province', 'https://cdn.example.com/images/binh-phuoc.jpg', 'Bình Phước', 58, 'Tỉnh Đông Nam Bộ, nhiều vùng trồng cây công nghiệp.', 'binh-phuoc'),
('province', 'https://cdn.example.com/images/binh-thuan.jpg', 'Bình Thuận', 92, 'Tỉnh ven biển, nổi tiếng Mũi Né và cảnh quan sa mạc ven biển.', 'binh-thuan'),
('province', 'https://cdn.example.com/images/ca-mau.jpg', 'Cà Mau', 66, 'Mũi Cà Mau - điểm cực Nam của đất nước, nhiều hệ sinh thái ngập mặn.', 'ca-mau'),
('province', 'https://cdn.example.com/images/cao-bang.jpg', 'Cao Bằng', 55, 'Vùng núi phía Bắc với thác Bản Giốc và nhiều di tích lịch sử.', 'cao-bang'),
('province', 'https://cdn.example.com/images/dak-lak.jpg', 'Đắk Lắk', 76, 'Tỉnh Tây Nguyên, nổi tiếng cà phê và văn hoá dân tộc.', 'dak-lak'),
('province', 'https://cdn.example.com/images/dak-nong.jpg', 'Đắk Nông', 54, 'Tỉnh Tây Nguyên với nhiều cảnh quan thiên nhiên hoang sơ.', 'dak-nong'),
('province', 'https://cdn.example.com/images/dien-bien.jpg', 'Điện Biên', 61, 'Tỉnh miền núi, nổi tiếng lịch sử Điện Biên Phủ.', 'dien-bien'),
('province', 'https://cdn.example.com/images/dong-nai.jpg', 'Đồng Nai', 125, 'Tỉnh có nhiều khu công nghiệp và khu du lịch sinh thái.', 'dong-nai'),
('province', 'https://cdn.example.com/images/dong-thap.jpg', 'Đồng Tháp', 70, 'Vùng đất sen hồng, nổi tiếng phong cảnh miền Tây.', 'dong-thap'),
('province', 'https://cdn.example.com/images/gia-lai.jpg', 'Gia Lai', 59, 'Tỉnh Tây Nguyên với cao nguyên, cà phê và văn hoá bản địa.', 'gia-lai'),
('province', 'https://cdn.example.com/images/ha-giang.jpg', 'Hà Giang', 99, 'Vùng cao nguyên đá nổi tiếng với đèo Mã Pì Lèng và hoa tam giác mạch.', 'ha-giang'),
('province', 'https://cdn.example.com/images/ha-nam.jpg', 'Hà Nam', 48, 'Tỉnh đồng bằng Bắc Bộ, gần Hà Nội với nhiều di tích lịch sử.', 'ha-nam'),
('province', 'https://cdn.example.com/images/ha-tinh.jpg', 'Hà Tĩnh', 63, 'Tỉnh miền Trung với bờ biển dài và di tích lịch sử.', 'ha-tinh'),
('province', 'https://cdn.example.com/images/hai-duong.jpg', 'Hải Dương', 57, 'Vùng đồng bằng Bắc Bộ, nổi tiếng nông sản và chợ hoa.', 'hai-duong'),
('province', 'https://cdn.example.com/images/hau-giang.jpg', 'Hậu Giang', 46, 'Tỉnh miền Tây với nhiều kênh rạch và nông nghiệp.', 'hau-giang'),
('province', 'https://cdn.example.com/images/hoa-binh.jpg', 'Hòa Bình', 64, 'Tỉnh miền núi phía Bắc, nhiều hồ và cảnh quan thiên nhiên.', 'hoa-binh'),
('province', 'https://cdn.example.com/images/hung-yen.jpg', 'Hưng Yên', 49, 'Vùng đồng bằng Bắc Bộ, nổi tiếng vải thiều và làng nghề.', 'hung-yen'),
('province', 'https://cdn.example.com/images/khanh-hoa.jpg', 'Khánh Hòa', 138, 'Tỉnh biển với Nha Trang — trung tâm du lịch biển nổi tiếng.', 'khanh-hoa'),
('province', 'https://cdn.example.com/images/kien-giang.jpg', 'Kiên Giang', 105, 'Tỉnh ven biển và đảo, bao gồm Phú Quốc và nhiều bãi biển đẹp.', 'kien-giang'),
('province', 'https://cdn.example.com/images/kon-tum.jpg', 'Kon Tum', 44, 'Tỉnh Tây Nguyên, nhiều văn hoá dân tộc và cảnh quan núi rừng.', 'kon-tum'),
('province', 'https://cdn.example.com/images/lai-chau.jpg', 'Lai Châu', 41, 'Tỉnh miền núi phía Bắc, cảnh quan hoang sơ và đèo dốc.', 'lai-chau'),
('province', 'https://cdn.example.com/images/lam-dong.jpg', 'Lâm Đồng', 132, 'Tỉnh cao nguyên Lâm Viên, nổi tiếng Đà Lạt và cảnh quan ôn đới.', 'lam-dong'),
('province', 'https://cdn.example.com/images/lang-son.jpg', 'Lạng Sơn', 47, 'Tỉnh biên giới phía Bắc, nhiều danh thắng và cửa khẩu thương mại.', 'lang-son'),
('province', 'https://cdn.example.com/images/lao-cai.jpg', 'Lào Cai', 90, 'Tỉnh miền núi, có Sa Pa và cảnh quan núi non hùng vĩ.', 'lao-cai'),
('province', 'https://cdn.example.com/images/long-an.jpg', 'Long An', 53, 'Tỉnh đồng bằng sông Cửu Long mở rộng, phát triển nông nghiệp.', 'long-an'),
('province', 'https://cdn.example.com/images/nam-dinh.jpg', 'Nam Định', 56, 'Vùng ven biển Bắc Bộ, có nhiều di tích lịch sử và lễ hội.', 'nam-dinh'),
('province', 'https://cdn.example.com/images/nghe-an.jpg', 'Nghệ An', 115, 'Tỉnh rộng lớn miền Trung, quê hương nhiều danh nhân lịch sử.', 'nghe-an'),
('province', 'https://cdn.example.com/images/ninh-binh.jpg', 'Ninh Bình', 127, 'Tỉnh có quần thể Tràng An, Bái Đính và nhiều cảnh quan kì vĩ.', 'ninh-binh'),
('province', 'https://cdn.example.com/images/ninh-thuan.jpg', 'Ninh Thuận', 50, 'Tỉnh ven biển miền Trung với nhiều vùng nắng gió và di sản Cham.', 'ninh-thuan'),
('province', 'https://cdn.example.com/images/phu-tho.jpg', 'Phú Thọ', 68, 'Đất Tổ Hùng Vương, có nhiều di tích lịch sử và lễ hội dân gian.', 'phu-tho'),
('province', 'https://cdn.example.com/images/phu-yen.jpg', 'Phú Yên', 74, 'Tỉnh ven biển miền Trung, nổi tiếng với bãi Rạn Yến và Gành Đá Dĩa.', 'phu-yen'),
('province', 'https://cdn.example.com/images/quang-binh.jpg', 'Quảng Bình', 89, 'Nổi tiếng hang Sơn Đoòng và nhiều hang động lớn.', 'quang-binh'),
('province', 'https://cdn.example.com/images/quang-nam.jpg', 'Quảng Nam', 123, 'Có phố cổ Hội An và nhiều di tích văn hoá, bãi biển đẹp.', 'quang-nam'),
('province', 'https://cdn.example.com/images/quang-ngai.jpg', 'Quảng Ngãi', 62, 'Tỉnh miền Trung với nhiều bãi biển và lịch sử hào hùng.', 'quang-ngai'),
('province', 'https://cdn.example.com/images/quang-ninh.jpg', 'Quảng Ninh', 210, 'Nổi tiếng Vịnh Hạ Long — di sản thiên nhiên thế giới.', 'quang-ninh'),
('province', 'https://cdn.example.com/images/quang-tri.jpg', 'Quảng Trị', 43, 'Tỉnh miền Trung giàu lịch sử với nhiều di tích chiến tranh.', 'quang-tri'),
('province', 'https://cdn.example.com/images/soc-trang.jpg', 'Sóc Trăng', 51, 'Tỉnh miền Tây có nền văn hoá Khmer và lễ hội đặc sắc.', 'soc-trang'),
('province', 'https://cdn.example.com/images/son-la.jpg', 'Sơn La', 59, 'Tỉnh miền núi phía Bắc, nổi tiếng chè và nông sản vùng cao.', 'son-la'),
('province', 'https://cdn.example.com/images/tay-ninh.jpg', 'Tây Ninh', 82, 'Tỉnh gần TP.HCM, có núi Bà Đen và điểm hành hương Cao Đài.', 'tay-ninh'),
('province', 'https://cdn.example.com/images/thai-binh.jpg', 'Thái Bình', 46, 'Vùng đồng bằng Bắc Bộ, nổi tiếng làng nghề và nông sản.', 'thai-binh'),
('province', 'https://cdn.example.com/images/thai-nguyen.jpg', 'Thái Nguyên', 71, 'Trung tâm vùng trung du miền núi phía Bắc, nổi tiếng chè.', 'thai-nguyen'),
('province', 'https://cdn.example.com/images/thanh-hoa.jpg', 'Thanh Hóa', 160, 'Tỉnh lớn miền Bắc có bờ biển dài và nhiều thắng cảnh.', 'thanh-hoa'),
('province', 'https://cdn.example.com/images/thua-thien-hue.jpg', 'Thừa Thiên - Huế', 145, 'Cố đô Huế với kiến trúc cung đình và di sản văn hoá phong phú.', 'thua-thien-hue'),
('province', 'https://cdn.example.com/images/tien-giang.jpg', 'Tiền Giang', 69, 'Tỉnh miền Tây, cửa ngõ sông nước và du lịch miệt vườn.', 'tien-giang'),
('province', 'https://cdn.example.com/images/tra-vinh.jpg', 'Trà Vinh', 47, 'Tỉnh miền Tây có nhiều di sản văn hoá Khmer.', 'tra-vinh'),
('province', 'https://cdn.example.com/images/tuyen-quang.jpg', 'Tuyên Quang', 42, 'Tỉnh miền núi phía Bắc với nhiều di tích lịch sử cách mạng.', 'tuyen-quang'),
('province', 'https://cdn.example.com/images/vinh-long.jpg', 'Vĩnh Long', 65, 'Tỉnh miền Tây sông nước, nổi tiếng chợ nổi và miệt vườn.', 'vinh-long'),
('province', 'https://cdn.example.com/images/vinh-phuc.jpg', 'Vĩnh Phúc', 77, 'Tỉnh gần Hà Nội, có khu công nghiệp và cảnh quan núi Tam Đảo.', 'vinh-phuc'),
('province', 'https://cdn.example.com/images/yen-bai.jpg', 'Yên Bái', 50, 'Tỉnh miền núi với ruộng bậc thang Mù Cang Chải và bản làng.', 'yen-bai');
