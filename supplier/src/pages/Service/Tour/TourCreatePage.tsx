      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-1">
            Nhập các thông tin bắt buộc và cơ bản về tour
          </p>
        </div>
          ...
          <div className="flex flex-col gap-2 md:col-span-2">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // Auto-generate slug mỗi khi title thay đổi
                if (newTitle.trim()) {
    ...
    () => (
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-1">
            Thông tin về thời gian và sức chứa của tour
          </p>
        </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // Tự động tính ngày kết thúc nếu đã có số ngày
    ...
    () => (
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-1">
            Chọn các tiện ích, dịch vụ và xây dựng hành trình chi tiết
          </p>
        </div>
    ...
    () => (
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-1">
            Upload ảnh, thiết lập chính sách và tối ưu SEO
          </p>
        </div>
        ...
        <div className="border-t theme-border pt-6">
          ...
          <div className="flex flex-col gap-2 mb-4">
            <label className={labelCls}>Slug (URL)
            ...
            <span className="theme-text-secondary text-caption-mobile">
              Slug sẽ được tạo tự động: ten-tour-123456789 (9 số ngẫu nhiên)
            </span>
          </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col gap-8">
      <div>
        ...
        <h1 className={pageTitle}>Tạo tour mới</h1>
          ...
          {currentStep < 4 ? (
            ...
            <button
              onClick={async () => {
                ...
                if (result && !result.success && result.missingFields.length > 0) {
                  const userConfirmed = window.confirm(
                    `⚠️ VUI LÒNG ĐIỀN ĐẦY ĐỦ CÁC TRƯỜNG BẮT BUỘC!\n\nCác trường còn thiếu:\n${result.missingFields.map(f => `• ${f}`).join('\n')}\n\nVui lòng kiểm tra và điền đầy đủ thông tin trước khi xuất bản.\n\nNhấn OK để tải lại trang.`
                  );
                  if (userConfirmed) {
                    window.location.reload();
                  }
