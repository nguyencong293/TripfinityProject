...
import { useAttractionEdit } from "../../../hooks/useAttractionEdit";
...
/* ================= Component ================= */
const AttractionEditPage: React.FC = () => {
  ...
  const {
    ...
    removeExistingImage,
    handleSubmit,
  } = useAttractionEdit(attractionId);
      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-1">
            Chỉnh sửa các thông tin cơ bản về điểm tham quan
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <select
              ...
              onChange={(e) => {
                const value = e.target.value as AttractionType;
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            <span className="theme-text-secondary text-caption-mobile">
              Slug tự động cập nhật: tên-điểm-tham-quan-123456789 (9 số ngẫu nhiên)
            </span>
          </div>
...
export default AttractionEditPage;
