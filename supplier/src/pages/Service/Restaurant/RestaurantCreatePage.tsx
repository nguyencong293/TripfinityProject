...
import { useRestaurantCreate } from "../../../hooks/useRestaurants";
        ...
        <div className="grid gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className={baseInput}
              placeholder="Nhập SEO title (tự động từ tên nhà hàng)"
              maxLength={255}
            />
          </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col gap-8">
      <div>
        ...
        <h1 className={pageTitle}>Tạo nhà hàng mới</h1>
        <p className="theme-text-secondary text-body2-mobile sm:text-body2-tablet mt-2">
          Điền đầy đủ thông tin để tạo nhà hàng mới
        </p>
      </div>
