...
import { getRestaurantsByProvider, getRestaurantReviewsByRestaurant } from "../../../services/restaurantService";
import { toggleReviewLike, checkIsLiked } from "../../../services/reviewService";
import type { RestaurantReviewDTO, UserDTO } from "../../../types";

interface ReviewWithUser extends RestaurantReviewDTO {
  user?: UserDTO;
    ...
    const loadData = async () => {
      try {
        ...
        for (const restaurant of restaurantsData) {
          ...
          const restaurantReviews = await getRestaurantReviewsByRestaurant(restaurant.restaurantId);
          ...
          {filteredReviews.map((review) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                <button
                  onClick={() => navigate(`/supplier/service/restaurant/reviews/${review.reviewId}`)}
