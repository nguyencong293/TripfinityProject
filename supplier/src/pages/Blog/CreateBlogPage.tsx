...
const CreateBlogPage = () => {
  ...
  // Handle submit
  const handleSubmit = async (status: "published" | "archived" = "published") => {
    ...
    try {
      ...
      alert(t("create_failed") || "Không thể tạo bài viết");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold theme-text-primary">
              {t("create_blog") || "Tạo bài viết mới"}
            </h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 rounded-lg border theme-border theme-text-secondary hover:theme-bg-secondary transition-colors disabled:opacity-50"
            >
              {t("save_draft") || "Lưu nháp"}
            </button>
            <button
