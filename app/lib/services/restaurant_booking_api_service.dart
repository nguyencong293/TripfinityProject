...
class RestaurantBookingApiService {
  final Dio _dio;

  RestaurantBookingApiService({
    required Dio dio,
  ...
  Future<Map<String, dynamic>> createBooking({
    ...
    final body = {
      ...
      if (reservationDate != null)
        'reservation_date': _formatDate(reservationDate),
    ...
    final res = await _dio.post('/restaurant-bookings', data: body);
  ...
  Future<List<Map<String, dynamic>>> getBookingsByUser(int userId) async {
    final res = await _dio.get('/restaurant-bookings/user/$userId');
