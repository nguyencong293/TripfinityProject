...
class _HotelOverviewSearchScreenState extends State<HotelOverviewSearchScreen> {
  ...
  final List<Map<String, String>> _hotels = List.generate(8, (i) {
    return {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                // Commit local copy to screen state
                                setState(() {
                                  _priceRange = price;
                                  _selectedStars
                                    ..clear()
  ...
  String _formatCurrency(double value) {
    ...
    return '$rev đ';
    // For real apps, use intl NumberFormat.
  }
