...
class DetailAttractionReviewUserScreen extends StatefulWidget {
  ...
  const DetailAttractionReviewUserScreen({
    super.key,
  ...
  @override
  State<DetailAttractionReviewUserScreen> createState() =>
      _DetailAttractionReviewUserScreenState();
}

class _DetailAttractionReviewUserScreenState
    extends State<DetailAttractionReviewUserScreen> {
  ...
  int _beautyRating = 5;
  int _cultureRating = 5;
  int _accessibilityRating = 5;
  int _priceRating = 5;
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      for (final image in _selectedImages) {
        final url = await _attractionApi.uploadReviewImage(image.path);
        imageUrls.add(url);
      }

      // Create the review
      await _attractionApi.createAttractionReview(
        ...
        imageUrls: imageUrls,
        aspects: {
          'beauty': _beautyRating,
          'culture': _cultureRating,
  ...
  Widget _buildAttractionInfoCard() {
    return Card(
      elevation: 2,
        ...
        child: Row(
          children: [
            ClipRRect(
              ...
              child: widget.attractionImage != null
                  ? Image.network(
                      widget.attractionImage!,
                      width: 70,
                      height: 70,
                      fit: BoxFit.cover,
              ...
              child: Column(
                children: [
                  _buildAspectRatingRow(
                    ...
                    Icons.landscape,
                    _beautyRating,
                    (v) => setState(() => _beautyRating = v),
                  ),
                  _buildAspectRatingRow(
                    'Văn hóa',
                    Icons.museum,
                    _cultureRating,
                    (v) => setState(() => _cultureRating = v),
                  ),
                  _buildAspectRatingRow(
                    'Khả năng tiếp cận',
                    Icons.accessible,
                    _accessibilityRating,
                    (v) => setState(() => _accessibilityRating = v),
                  ),
                  _buildAspectRatingRow(
                    'Giá cả',
                    Icons.attach_money,
                  ...
                  _buildAspectRatingRow(
                    ...
                    _facilitiesRating,
                    (v) => setState(() => _facilitiesRating = v),
                  ),
                ],
              ),
            ),
