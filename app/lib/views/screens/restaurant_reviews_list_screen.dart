...
class RestaurantReviewsListScreen extends StatefulWidget {
  final int restaurantId;
  final String restaurantName;

  const RestaurantReviewsListScreen({
    super.key,
...
class _RestaurantReviewsListScreenState
  ...
  late RestaurantApiService _restaurantApi;
  ...
  Future<void> _initServices() async {
    ...
    _restaurantApi = RestaurantApiService(dio: dio, prefs: prefs);
  ...
  Future<void> _loadReviews() async {
    try {
      ...
      final reviews = await _restaurantApi.getRestaurantReviews(
        widget.restaurantId,
      );
