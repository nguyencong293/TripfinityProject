...
class DetailRestaurantReviewUserScreen extends StatefulWidget {
  final int restaurantId;
  final String restaurantName;
  final String restaurantLocation;
  final String restaurantImage;

  const DetailRestaurantReviewUserScreen({
    super.key,
  ...
  @override
  State<DetailRestaurantReviewUserScreen> createState() =>
      _DetailRestaurantReviewUserScreenState();
}

class _DetailRestaurantReviewUserScreenState
    extends State<DetailRestaurantReviewUserScreen> {
  ...
  // Restaurant-specific aspects (1-5 stars)
  ...
  Future<void> _submitReview() async {
    ...
    if (_qualityRating == 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng đánh giá chất lượng'),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    if (_priceRating == 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng đánh giá giá cả'),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    if (_ambienceRating == 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng đánh giá không khí'),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    try {
      ...
      await api.createRestaurantReview(
      ...
      // Go back to Restaurant detail and refresh
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _RestaurantHeader(
                      ...
                      location: widget.restaurantLocation,
                    ...
                    _AspectRating(
                      ...
                      rating: _priceRating,
                      onChanged: (val) => setState(() => _priceRating = val),
                    ),
                    const SizedBox(height: 12),
                    _AspectRating(
                      label: 'Vị trí',
                    ...
                    _AspectRating(
                      ...
                      onChanged: (val) => setState(() => _ambienceRating = val),
                    ),
