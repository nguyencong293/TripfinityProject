...
class TourReviewsListScreen extends StatefulWidget {
  final int tourId;
  final String tourName;

  const TourReviewsListScreen({
    super.key,
  ...
  @override
  State<TourReviewsListScreen> createState() => _TourReviewsListScreenState();
}

class _TourReviewsListScreenState extends State<TourReviewsListScreen> {
  ...
  Future<void> _loadReviews() async {
    try {
      ...
      final reviews = await _tourApi.getTourReviews(widget.tourId);
